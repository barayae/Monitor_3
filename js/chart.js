...
function pieChart() {
  ...
  var pullOutLabelFont = "18px 'Trebuchet MS', Verdana, sans-serif";  // Pull-out slice label font
  var pullOutValueFont = "18px 'Trebuchet MS', Verdana, sans-serif";  // Pull-out slice value font
